...
export default function ProfileScreen({ user, onLogout, onSaveSuccess }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {/* Genre – STYLE HOMME / FEMME IDENTIQUE AU PREMIER CODE */}
      ...
      <View style={styles.genderContainer}>
        <TouchableOpacity
          style={[
            styles.genderOption,
            form.gender === 'Homme' && styles.genderSelected,
          ]}
        ...
        >
          <Text
            style={[
              styles.genderText,
              form.gender === 'Homme' && styles.genderTextSelected,
            ]}
          >
            Homme
          </Text>
        ...
        <TouchableOpacity
          style={[
            styles.genderOption,
            form.gender === 'Femme' && styles.genderSelected,
          ]}
        ...
        >
          <Text
            style={[
              styles.genderText,
              form.gender === 'Femme' && styles.genderTextSelected,
            ]}
          >
            Femme
          </Text>
      ...
      >
        <Text style={styles.selectText}>
          {form.activity_level || 'Sélectionner un niveau d’activité'}
        </Text>
      </TouchableOpacity>
      ...
      <View style={styles.buttonWrapper}>
        <Button title="Sauvegarder" onPress={handleSave} color="#28B572" />
      </View>
...
const styles = StyleSheet.create({
  ...
  /* GENRE – STYLE IDENTIQUE À TON PREMIER CODE */
  genderContainer: {
    flexDirection: 'row',
